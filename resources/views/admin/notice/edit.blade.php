...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-fang-add" method="post" action="{{ route('admin.fang.update',$fang) }}">
        @csrf
        @method('PUT')
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <span class="select-box" style="width: 362px;">
                    <input type="text" class="select" placholder="房源详细地址" name="fang_addr" value="{{ $fang->fang_addr }}">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box" style="width: 362px;">
					<input type="text" class="select" placholder="房源面积" name="fang_build_area" value="{{ $fang->fang_build_area }}">
				</span>
                <span class="select-box" style="width: 362px;">
					<input type="text" class="select" placholder="使用面积" name="fang_using_area" value="{{ $fang->fang_using_area }}">
				</span>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box" style="width: 362px;">
					<input type="text" class="select" placholder="建筑年代" name="fang_year" value="{{ $fang->fang_year }}">
				</span>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box" style="width: 80px;">
					<input type="text" class="select" placholder="房源楼层" name="fang_floor" value="{{ $fang->fang_floor }}">
				</span>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <label>
                        <input name="fang_status" type="radio" value="0" @if($fang->fang_status==0) selected @endif>
                        待租
                    </label>
                </div>
                <div class="radio-box">
                    <label>
                        <input name="fang_status" type="radio" value="1" @if($fang->fang_status==1) selected @endif>
                        已租
                    </label>
                </div>
            </div>
                    ...
                    <span class="select-box" style="width: 362px;">
                        <select name="fang_owner" class="select">
                            @foreach($fData as $item)
                                <option value="{{ $item['id'] }}" @if($fang->fang_owner == $item->id) checked @endif>{{ $item['name'] }}</option>
                            @endforeach
                        </select>
                    </span>
            </div>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 修改新房源</button>
            </div>
        </div>
    </form>
</article>
